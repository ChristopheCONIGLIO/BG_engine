...
class BluePrint extends BG_script{
    ...
    enterFrame(){
        ...
        // trace les lignes
        //
        this.traceXLine(this.p_gap ,1,"#4499c6");
        this.traceYLine(this.p_gap ,1,"#4499c6");
        this.traceXLine(this.p_gap*10 ,2,"#A1CCE2");
        this.traceYLine(this.p_gap*10 ,2,"#A1CCE2");
        if( this.p_traceText )this.traceText(this.p_gap*10,"#A1CCE2")
    ...
    traceText(difPETIT,color){
        ...
        while(true){
            ...
            while(true){
                ...
                this.lineOnBoardArrText[this.countGlobalText].setText("("+px1+","+py1+")");
